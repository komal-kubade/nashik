    ...
    <div class="container py-5">
        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-4">
                <div class="bg-white rounded p-4">
                    <div class="text-center mb-4">
                        ...
                        <p class="mb-0">GPS99 Hotel, Indira Nagar<br> Nashik, Maharashtra.</p>
                    </div>
                    <div class="text-center mb-4">
            ...
            <div class="col-lg-8">
                ...
                <p class="mb-4">We will be happy to help you</p>
                <form action="server.php" method="POST">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <!-- Update 'name' to 'description' to match the PHP code -->
                                <input type="text" class="form-control border-0" id="description" name="description" placeholder="Subject" required>
                                <label for="description">Subject</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                                <!-- Update 'name' to 'message' to match the PHP code -->
            ...
            <div class="col-12">
                <div class="rounded">
                    ...
                    style="height: 450px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d119981.39107477631!2d73.72107877635628!3d19.990944013030575!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bddd290b09914b3%3A0xcb07845d9d28215c!2sNashik%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1708408529620!5m2!1sen!2sin" 
